...
![../_images/bitwiseNOT_2x.png](../_images/bitwiseNOT_2x.png)
...
![../_images/bitwiseAND_2x.png](../_images/bitwiseAND_2x.png)
...
![../_images/bitwiseOR_2x.png](../_images/bitwiseOR_2x.png)
...
![../_images/bitwiseXOR_2x.png](../_images/bitwiseXOR_2x.png)
...
![../_images/bitshiftUnsigned_2x.png](../_images/bitshiftUnsigned_2x.png)
...
![../_images/bitshiftSignedFour_2x.png](../_images/bitshiftSignedFour_2x.png)
...
![../_images/bitshiftSignedMinusFour_2x.png](../_images/bitshiftSignedMinusFour_2x.png)

This time, the sign bit is `1` (meaning “negative”), and the seven value bits have a binary value of `124` (which is `128 - 4`):

![../_images/bitshiftSignedMinusFourValue_2x.png](../_images/bitshiftSignedMinusFourValue_2x.png)
...
![../_images/bitshiftSignedAddition_2x.png](../_images/bitshiftSignedAddition_2x.png)
...
![../_images/bitshiftSigned_2x.png](../_images/bitshiftSigned_2x.png)
...
![../_images/overflowAddition_2x.png](../_images/overflowAddition_2x.png)
...
![../_images/overflowUnsignedSubtraction_2x.png](../_images/overflowUnsignedSubtraction_2x.png)
...
![../_images/overflowSignedSubtraction_2x.png](../_images/overflowSignedSubtraction_2x.png)
...
![../_images/vectorAddition_2x.png](../_images/vectorAddition_2x.png)
...
You can declare and implement your own *custom operators* in addition to the standard operators provided by Swift. For a list of characters that can be used to define custom operators, see [Operators](../ReferenceManual/LexicalStructure.xhtml#ID418).
...
This operator adds together the `x` values of two vectors, and subtracts the `y` value of the second vector from the first. Because it is in essence an “additive” operator, it has been given the same precedence group as additive infix operators such as `+` and `-`. For information about the operators provided by the Swift standard library, including a complete list of the operator precedence groups and associativity settings, see [Operator Declarations](https://developer.apple.com/documentation/swift/operator_declarations). For more information about precedence groups and to see the syntax for defining your own operators and precedence groups, see [Operator Declaration](../ReferenceManual/Declarations.xhtml#ID380).
